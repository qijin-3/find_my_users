---
title: Accessing the Admin Panel and Managing Resources in FindMyUsers
description: How to access the admin panel and manage your resource list in FindMyUsers
date: '2024-08-11T13:14:40.737Z'
lastModified: '2024-11-06T03:24:55.263Z'
---
# Accessing the Admin Panel and Managing Resources in FindMyUsers

FindMyUsers provides a user-friendly admin interface for managing your website's resources. This guide will walk you through the process of accessing the admin panel and managing your resources effectively.

## Accessing the Admin Panel

1. **Navigate to the Admin URL**: Open your web browser and go to your FindMyUsers website's URL, followed by `/admin`. For example: `https://yourfindmyuserssite.com/admin`.
...
Note: The current version of FindMyUsers might not support direct deletion through the admin interface. If you need to remove a resource:
...
By following these steps, you should be able to effectively manage the resources on your FindMyUsers website through the admin panel. Remember, all changes are version-controlled through GitHub, allowing you to track modifications and revert if necessary.
