...
- **2026-09-14**: 移除管理后台
- 删除登录/admin 页面与认证相关 API，内容改为直接通过仓库 `data/` 代码更新
- 仅保留只读 `/api/fields` 供前端筛选使用，无新增 UI 文案变更


- **2026-09-14**: 升级至 Next.js 15.5.25 / React 19 以支持 Cloudflare OpenNext
- 无新增 UI 文案；路由与 messages 结构保持不变
